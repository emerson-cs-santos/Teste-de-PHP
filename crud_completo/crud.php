...
$codigo	= @$_POST['codigo'];
// Se o código estiver preenchido pelo post, foi chamado pela página de alteração
if($codigo>0)
{
	$tipo='alt';
}
...
// Pega o value do name do botão submit deste form
$tipo = @$_POST['insert'];
        ...
        <section>
            <form id="form" action="crud.php" method="POST">
				...
				<div>
					...
					<input type="text" id="codigo" class="form-control-sm" name="codigo" placeholder="Código usuario" value = "" disabled >
				</div>
