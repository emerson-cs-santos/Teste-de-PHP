...
$objUusuario->loadUser($codigo);

$codigo  = $objUusuario->getcodigo();	
$nome    = $objUusuario->getnome();
$email   = $objUusuario->getemail();    
$senha   = $objUusuario->getsenha();
